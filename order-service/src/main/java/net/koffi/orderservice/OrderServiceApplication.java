package net.koffi.orderservice;

import net.koffi.orderservice.entities.Order;
import net.koffi.orderservice.entities.OrderState;
import net.koffi.orderservice.entities.ProductItem;
import net.koffi.orderservice.repsoitories.OrderRepository;
import net.koffi.orderservice.repsoitories.ProductItemRepository;
import net.koffi.orderservice.restclients.InventoryRestClient;
